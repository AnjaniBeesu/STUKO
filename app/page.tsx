...
import { BookOpen, Brain, Clock3, FileText, Layers3, Play, Sparkles, Trophy, Users, ArrowUpRight, ChevronDown, UserRound, Settings } from 'lucide-react';
  ...
  return (
    <main className="landing">
      <style jsx global>{`
        ...
        .landing-profile{position:relative;display:flex;align-items:center;gap:9px;font-size:11px;font-weight:700}.profile-trigger{display:flex;align-items:center;gap:8px;border:0;background:transparent;color:#10191c;padding:3px;border-radius:12px;cursor:pointer}.profile-trigger:hover{background:rgba(255,255,255,.35)}.profile-chevron{transition:transform .2s}.profile-chevron.open{transform:rotate(180deg)}
        ...
        <div className="landing-profile">
          ...
          {profileMenuOpen && (
            <div className="profile-menu">
              ...
              <button className="profile-menu-item" onClick={() => window.location.href='/profile'}><UserRound size={14} /> Profile page</button>
