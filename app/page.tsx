...
import { BookOpen, Brain, Clock3, FileText, Layers3, Play, Sparkles, Trophy, Users, ArrowUpRight, ChevronDown, UserRound, Settings, Palette } from 'lucide-react';
          ...
          <div className="landing-profile">
            ...
            {profileMenuOpen && (
              <div className="profile-menu">
                ...
                <button className="profile-menu-item" onClick={() => window.location.href='/edit-profile'}><UserRound size={14} /> Edit my profile</button>
